...
|------|---------------------|
| [MyST Markdown](myst_markdown.md) | Basic syntax for writing book pages |
| [Figures and images](figures.md) | Inserting and referencing images |
| [Equations](equations.md) | Inline and display math |
| [Citations and bibliography](citations_bibliography.md) | BibTeX bibliography |
| [Cross-references](cross_references.md) | Linking figures, tables, sections… |
| [Tables](tables.md) | Simple and formatted tables |
| [Admonitions and dropdowns](admonitions_dropdowns.md) | Notes, warnings, hints, collapsible blocks |
